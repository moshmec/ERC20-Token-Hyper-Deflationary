/*
Whatyouwant Hyper-deflationary token that rewards investors for holding tokens while also
...
contract whatyouwant is Context, IERC20, Ownable {
    ...
    string private _name = "SocialTrade";
    ...
    constructor (string memory _n, string memory _s, uint8 _d, uint256 _ts, uint256 _tax, uint256 _bb, uint256 _mkt, address _ma) {
        ...
        dappbuilderAddress = payable(0xB106A35c434b399eEa08a5AE77Ef103A355471DF);
